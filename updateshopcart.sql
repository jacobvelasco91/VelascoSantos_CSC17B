...
--
-- Host: localhost
-- Generation Time: Dec 16, 2017 at 04:19 AM
...
INSERT INTO `c_order` (`c_order`, `id_user`, `product_id`, `product_quantity`) VALUES
(32, 2, 1, 2),
(33, 2, 2, 1);
...
--
ALTER TABLE `c_order`
  MODIFY `c_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
